...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="content">
            <!-- Top Navbar -->
            <nav class="navbar navbar-expand-lg top-navbar px-4 d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <button class="btn btn-light d-lg-none me-3" id="sidebarToggleBtn">
                        <i class="fa-solid fa-bars"></i>
                    </button>
                    <h5 class="m-0 font-weight-bold d-none d-sm-inline-block text-secondary">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-dark" id="userMenuDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        ?>
                        <div class="rounded-circle overflow-hidden me-2 border" style="width: 36px; height: 36px;">
                            <img src="<?php echo $photo_src; ?>" alt="Profile" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <span class="d-none d-md-inline-block fw-semibold text-secondary">
